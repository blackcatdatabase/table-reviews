...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'tenant_id', 'book_id', 'user_id', 'rating', 'review_text', 'created_at', 'updated_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'tenant_id', 'book_id', 'user_id' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'tenant_id', 'book_id', 'user_id', 'rating' ]; }
