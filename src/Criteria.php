...
final class Criteria extends BaseCriteria
{
    ...
    {
        $x = [ 'id', 'tenant_id', 'book_id', 'user_id', 'rating', 'review_text', 'created_at', 'updated_at' ];
    ...
    protected function joinable(): array
    {
        ...
        return [ 'tenants' => 'j0', 'books' => 'j1', 'users' => 'j2' ];
    }
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\Reviews\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\Reviews\Definitions::softDeleteColumn();
