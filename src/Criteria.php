 ...
 * - whitelist filtrů: [ 'id', 'book_id', 'user_id', 'rating', 'review_text', 'created_at', 'updated_at' ]
 * - whitelist pro LIKE hledání: [ 'review_text' ]
 */
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        // filtry (rovnosti / IN)
        $allowed = array_fill_keys([ 'id', 'book_id', 'user_id', 'rating', 'review_text', 'created_at', 'updated_at' ], true);
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'book_id', 'user_id', 'rating', 'review_text', 'created_at', 'updated_at' ], true);
            $parts = [];
