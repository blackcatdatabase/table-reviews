...
final class ReviewDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'book_id' => 'bookId', 'user_id' => 'userId', 'review_text' => 'reviewText', 'created_at' => 'createdAt', 'updated_at' => 'updatedAt' ];
    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'book_id', 'user_id', 'rating' ];
    /** @var string[] */
    ...
    /** @var string[] */
    private const NULLABLE    = [ 'id', 'user_id', 'review_text', 'updated_at' ];
