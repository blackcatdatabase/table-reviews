...
namespace BlackCat\Database\Packages\Reviews\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO ReviewDto:
 ...
 */
final class ReviewDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'tenant_id' => 'tenantId', 'book_id' => 'bookId', 'user_id' => 'userId', 'rating' => 'rating', 'review_text' => 'reviewText', 'created_at' => 'createdAt', 'updated_at' => 'updatedAt' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'tenant_id', 'book_id', 'user_id', 'rating' ];
    /** @var string[] */
     ...
     * @return ReviewDto
     */
    public static function fromRow(array $row): ReviewDto
    {
        /** @var ReviewDto */
    ...
    public static function fromRowOrNull(?array $row): ?ReviewDto
    {
     ...
     */
    public static function toRow(ReviewDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(ReviewDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(ReviewDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(ReviewDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,ReviewDto>
     */
