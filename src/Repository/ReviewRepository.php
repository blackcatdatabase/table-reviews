...
use BlackCat\Database\Packages\Reviews\Repository\ReviewRepositoryInterface;
...
class ReviewRepository implements ReviewRepositoryInterface, RepoContract, KeysetRepoContract
{
use OrderByTools, PkTools, RepositoryHelpers;
    ...
    public function upsertMany(array $rows): int {
        ...
        if ($helperKeys && class_exists(\BlackCat\Database\Support\BulkUpsertHelper::class)) {
          $bulk = new \BlackCat\Database\Support\BulkUpsertHelper($this->db, \BlackCat\Database\Packages\Reviews\Definitions::class);
    ...
    public function getByTenantIdAndBookIdAndUserId(int $tenantId, int $bookId, int $userId, bool $asDto = false): array|\BlackCat\Database\Packages\Reviews\Dto\ReviewDto|null {
        return $this->getByUnique([ 'tenant_id' => $tenantId, 'book_id' => $bookId, 'user_id' => $userId ], $asDto);
    }
    ...
    public function getIdByTenantIdAndBookIdAndUserId(int $tenantId, int $bookId, int $userId) {
        $row = $this->getByTenantIdAndBookIdAndUserId($tenantId, $bookId, $userId, false);
