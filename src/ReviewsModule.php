...
{
    public function name(): string { return 'table-reviews'; }
    public function table(): string { return 'reviews'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-books', 'table-tenants', 'table-users' ]; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_reviews_created_at', 'idx_reviews_tenant_book', 'idx_reviews_user_id', 'ux_reviews_tenant_book_user' ];
        if ($d->isMysql()) {
        ...
        $expectedFk  = [ 'fk_reviews_book', 'fk_reviews_tenant', 'fk_reviews_user' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_reviews_created_at', 'idx_reviews_tenant_book', 'idx_reviews_user_id', 'ux_reviews_tenant_book_user' ],
