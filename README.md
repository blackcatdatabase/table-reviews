...
| Pkg folder | [packages/reviews](https://github.com/blackcatacademy/blackcat-database/blob/main/packages/reviews) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package reviews -Apply
