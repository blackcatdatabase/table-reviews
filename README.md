...
- Pkg folder: [packages\reviews](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\reviews)
...
graph LR
  ...
  reviews -->|FK| books["books"]:::link
  reviews -->|FK| tenants["tenants"]:::accent
  reviews -->|FK| users["users"]:::link
...
- Outbound (depends on): "books", "tenants", "users"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package reviews -Apply
